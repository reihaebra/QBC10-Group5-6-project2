    ...
    <div className="flex flex-col gap-5">
      ...
      <section className="bg-base-side-light dark:bg-[var(--color-base-side-dark)] rounded-lg p-6 space-y-6 flex justify-between text-right">
          ...
          <div className="p-4 flex-1 flex-col gap-4 max-w-66">
            ...
            <p className="text-base text-primary-text-light dark:text-[var(--color-primary-text-dark)]"><span className='text-secondary-light dark:text-[var(--color-secondary-dark)]'>آدرس:</span> {country}، {city}، {address}، کدپستی: {postal}</p>
          </div>
