    ...
    <>
      ...
      <div className="font-yekan-bakh flex gap-16 bg-background-base-light dark:bg-[var(--color-background-primary-dark)]">
        ...
        <div id="productIntroduce" className="flex flex-col gap-11 w-1/3 h-1/3">
          <h3 className="font-semibold text-2xl text-primary-text-light dark:text-[var(--color-primary-text-dark)]">
            {product?.name}
          </h3>
          <p className="text-primary-text-light font-normal text-base dark:text-[var(--color-primary-text-dark)]">
            {product?.description}
          </p>
          <span className="text-3xl font-bold text-primary-text-light dark:text-[var(--color-primary-text-dark)]">
          ...
          <div id="productDetail" className="flex justify-between">
            ...
            >
              <div className="flex gap-2">
                ...
                />
                <h6 className="text-secondary-light dark:text-[var(--color-secondary-dark)]">
                  امتیاز :
                </h6>
          ...
          <div className="flex justify-between">
            <div className="flex items-center gap-2 text-primary-text-light dark:text-[var(--color-primary-text-dark)]">
