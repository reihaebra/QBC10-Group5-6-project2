...
const ShoppingProgress3 = (props: addressProps) => {
  ...
  return (
    <main
      className="flex-1 h-screen bg-background-base-light dark:bg-[var(--color-background-primary-dark)] 
    mr-20 flex flex-col justify-center items-center pt-12 gap-18 font-yekan-bakh "
    >
