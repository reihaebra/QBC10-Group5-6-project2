...
const CustomerInfo = ({ data }: any) => {
  return (
    <div className="w-full">
      <h2 className="font-medium text-xl text-right mb-3">آدرس دریافت</h2>
      ...
      <div className="flex flex-col justify-between items-start gap-4 text-base leading-relaxed">
        <div className="flex items-center gap-3">
          ...
          <span className="font-normal text-primary-text-light dark:text-on-primary-light">
            {data.phone}
          </span>
        </div>
