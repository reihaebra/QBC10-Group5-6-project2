  ...
  return (
    <div className="font-yekan-bakh">
      <form
        ...
        className="rounded-lg p-4 flex flex-col gap-6 text-right transition-colors duration-300 relative"
      >
        <div className="relative">
          ...
          <div
            ...
            className={`cursor-pointer w-full rounded-md border border-gray-300 dark:border-neutral-700 
  ...
  <img
    ...
    className={`w-4 h-4 transition-transform duration-200 ${
      isOpen ? "rotate-180" : ""
          ...
          {isOpen && (
            <ul
              className="absolute z-10 mt-1 w-full bg-white dark:bg-neutral-900 border border-[var(--color-input-light)] dark:border-[var(--color-input-dark)]
        ...
        <div className="mt-5">
          ...
          <textarea
            ...
            className="w-full rounded-md border border-[var(--color-input-light)] dark:border-[var(--color-input-dark)] bg-white dark:bg-[var(--color-base-text-field-dark)] text-gray-900 dark:text-gray-100 px-3 py-2 h-28 resize-none focus:outline-none focus:ring-2 focus:ring-pink-500 placeholder-gray-400 dark:placeholder-gray-400"
          />
        </div>

        <button
          type="submit"
          className="self-start bg-pink-600 text-white px-4 py-2 rounded-md hover:bg-pink-700 transition"
        >
          ثبت نظر
        </button>
      </form>
